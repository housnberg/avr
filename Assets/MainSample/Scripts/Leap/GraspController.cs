...
public class GraspController : MonoBehaviour {
    ...
    protected void UpdateGraspPosition() {
        ...
        this.CurrentGraspCenter = 0.5f * (handModel.fingers[0].GetTipPosition() + handModel.fingers[1].GetTipPosition());
    ...
    protected void UpdatePalmRotation() {
        ...
        this.PalmRotation = Quaternion.Slerp(this.PalmRotation, handModel.GetPalmRotation(), 1.0f - this.RotationFiltering);
    }
